...
SIO_PORT = 38283
SIO_PORT2 = 38223
SIO_PORT_REDIS_1 = SIO_PORT + 1
SIO_PORT_REDIS_2 = SIO_PORT + 2
WS_SERVER_URL = f"ws://127.0.0.1:{SIO_PORT}/ws"
SERVER_URL = f"http://127.0.0.1:{SIO_PORT}"
WS_SERVER_URL_REDIS_1 = f"ws://127.0.0.1:{SIO_PORT_REDIS_1}/ws"
SERVER_URL_REDIS_1 = f"http://127.0.0.1:{SIO_PORT_REDIS_1}"
WS_SERVER_URL_REDIS_2 = f"ws://127.0.0.1:{SIO_PORT_REDIS_2}/ws"
