...
|---------|---------|---------|
| 0.21.76 | worker_managed session persist fix (PR #930) | **LIVE** (deployed 2026-03-07, 05:48 UTC) |
...
> **Note**: Live server is at **0.21.76** (deployed Mar 7 2026, 05:48 UTC). Heartbeat leak fixed. Redis pool ~560 at 530 active connections (proportional, ~1.06 per connection). Crisis was 1218 pre-upgrade; threshold set at 900.
