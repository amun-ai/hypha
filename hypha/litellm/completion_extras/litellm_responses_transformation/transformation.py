...
from hypha.litellm import ModelResponse
from hypha.litellm._logging import verbose_logger
from hypha.litellm.llms.base_llm.base_model_iterator import BaseModelResponseIterator
from hypha.litellm.llms.base_llm.bridges.completion_transformation import (
    CompletionTransformationBridge,
)
from hypha.litellm.types.llms.openai import Reasoning

if TYPE_CHECKING:
    from openai.types.responses import ResponseInputImageParam
    from pydantic import BaseModel

    from hypha.litellm import LiteLLMLoggingObj, ModelResponse
    from hypha.litellm.llms.base_llm.base_model_iterator import BaseModelResponseIterator
    ...
    from hypha.litellm.types.utils import GenericStreamingChunk, ModelResponseStream
...
class LiteLLMResponsesTransformationHandler(CompletionTransformationBridge):
    ...
    def transform_request(
        ...
        from hypha.litellm.types.llms.openai import ResponsesAPIOptionalRequestParams
        ...
        from hypha.litellm.types.utils import CallTypes
    ...
    def transform_response(
        ...
        from hypha.litellm.types.llms.openai import ResponsesAPIResponse
        from hypha.litellm.types.utils import Choices, Message
    ...
    def _convert_content_to_responses_format(
        ...
        from hypha.litellm.types.llms.openai import ChatCompletionImageObject
...
class OpenAiResponsesToChatCompletionStreamIterator(BaseModelResponseIterator):
    ...
    def chunk_parser(
        ...
        from hypha.litellm.types.llms.openai import ChatCompletionToolCallFunctionChunk
