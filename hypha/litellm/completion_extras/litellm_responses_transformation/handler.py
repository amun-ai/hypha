...
if TYPE_CHECKING:
    from hypha.litellm import CustomStreamWrapper, LiteLLMLoggingObj, ModelResponse
...
class ResponsesToCompletionBridgeHandler:
    ...
    def validate_input_kwargs(
        ...
        from hypha.litellm import LiteLLMLoggingObj
    ...
    def completion(self, *args, **kwargs) -> Union[
        ...
        from hypha.litellm import responses
    ...
    async def acompletion(
        ...
        from hypha.litellm import aresponses
        from hypha.litellm.litellm_core_utils.streaming_handler import CustomStreamWrapper
        from hypha.litellm.types.llms.openai import ResponsesAPIResponse
