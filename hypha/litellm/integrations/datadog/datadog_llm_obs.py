...
from hypha.litellm.types.integrations.datadog_llm_obs import *
...
class DataDogLLMObsLogger(DataDogLogger, CustomBatchLogger):
    ...
    def _get_datadog_llm_obs_params(self) -> Dict:
        """
        Get the datadog_llm_observability_params from hypha.litellm.datadog_llm_observability_params
