...
from hypha.litellm.types.integrations.argilla import ArgillaItem
from hypha.litellm.types.llms.openai import AllMessageValues, ChatCompletionRequest
...
if TYPE_CHECKING:
    ...
    from hypha.litellm.types.router import PreRoutingHookResponse
...
class CustomLogger:  # https://docs.litellm.ai/docs/observability/custom_callback#callback-class
    ...
    def _select_metadata_field(
        ...
        """
        from hypha.litellm.constants import LITELLM_METADATA_FIELD, OLD_LITELLM_METADATA_FIELD
    ...
    def redact_standard_logging_payload_from_model_call_details(
        ...
        from hypha.litellm import Choices, Message, ModelResponse
        from hypha.litellm.types.utils import LiteLLMCommonStrings
