...
from hypha.litellm.constants import DEFAULT_S3_BATCH_SIZE, DEFAULT_S3_FLUSH_INTERVAL_SECONDS
...
from hypha.litellm.types.integrations.s3_v2 import s3BatchLoggingElement
...
class S3Logger(CustomBatchLogger, BaseAWSLLM):
    ...
    async def async_upload_data_to_s3(
        ...
        try:
            from hypha.litellm.litellm_core_utils.asyncify import asyncify
