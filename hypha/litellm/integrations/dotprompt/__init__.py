...
if TYPE_CHECKING:
    ...
    from hypha.litellm.types.prompts.init_prompts import PromptLiteLLMParams, PromptSpec
    from hypha.litellm.integrations.custom_prompt_management import CustomPromptManagement

from hypha.litellm.types.prompts.init_prompts import SupportedPromptIntegrations
