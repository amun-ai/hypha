...
from hypha.litellm.types.services import ServiceLoggerPayload
...
if TYPE_CHECKING:
    ...
    from hypha.litellm.proxy.proxy_server import UserAPIKeyAuth as _UserAPIKeyAuth
...
class OpenTelemetry(CustomLogger):
    ...
    def set_tools_attributes(self, span: Span, tools):
        ...
        from hypha.litellm.proxy._types import SpanAttributes
    ...
    def set_attributes(  # noqa: PLR0915
        ...
        try:
            if self.callback_name == "arize_phoenix":
                from hypha.litellm.integrations.arize.arize_phoenix import ArizePhoenixLogger
                ...
                from hypha.litellm.integrations.langtrace import LangtraceAttributes
                ...
                from hypha.litellm.integrations.langfuse.langfuse_otel import (
                    LangfuseOtelLogger,
                )
