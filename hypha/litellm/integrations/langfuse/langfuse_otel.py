...
from hypha.litellm.integrations.arize import _utils
from hypha.litellm.integrations.opentelemetry import OpenTelemetry
from hypha.litellm.types.integrations.langfuse_otel import (
    LangfuseOtelConfig,
    LangfuseSpanAttributes,
)
from hypha.litellm.types.utils import StandardCallbackDynamicParams
...
if TYPE_CHECKING:
    ...
    from hypha.litellm.types.integrations.arize import Protocol as _Protocol
...
class LangfuseOtelLogger(OpenTelemetry):
    ...
    def _extract_langfuse_metadata(kwargs: dict) -> dict:
        ...
        try:
            from hypha.litellm.integrations.langfuse.langfuse import (
    ...
    def _set_langfuse_specific_attributes(span: Span, kwargs):
        ...
        compatibility.
        """
        from hypha.litellm.integrations.arize._utils import safe_set_attribute
