...
from hypha.litellm.responses.main import aresponses
from hypha.litellm.responses.streaming_iterator import BaseResponsesAPIStreamingIterator
from hypha.litellm.types.llms.openai import ResponsesAPIResponse, ToolParam
...
class LiteLLM_Proxy_MCP_Handler:
    ...
    def _transform_mcp_tools_to_openai(mcp_tools: List[Any]) -> List[Any]:
        ...
        from hypha.litellm.experimental_mcp_client.tools import (
    ...
    def _add_mcp_output_elements_to_response(
        ...
        from hypha.litellm.types.responses.main import GenericResponseOutputItem, OutputText
