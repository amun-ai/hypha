...
from hypha.litellm.types.responses.main import DecodedResponseId
from hypha.litellm.types.utils import SpecialEnums, Usage
...
class ResponsesAPIRequestUtils:
    ...
    def get_optional_params_responses_api(
        ...
        """
        from hypha.litellm.utils import _apply_openai_param_overrides
    ...
    def get_requested_response_api_optional_param(
        ...
        """
        from hypha.litellm.utils import PreProcessNonDefaultParams
        ...
        if "metadata" in non_default_params:
            from hypha.litellm.utils import add_openai_metadata
