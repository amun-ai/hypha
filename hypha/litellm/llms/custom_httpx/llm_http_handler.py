...
import hypha.litellm.types
import hypha.litellm.types.utils
from hypha.litellm._logging import verbose_logger
from hypha.litellm.litellm_core_utils.realtime_streaming import RealTimeStreaming
...
from hypha.litellm.llms.base_llm.base_model_iterator import MockResponseIterator
...
from hypha.litellm.llms.custom_httpx.http_handler import (
    AsyncHTTPHandler,
    HTTPHandler,
    _get_httpx_client,
    get_async_httpx_client,
)
from hypha.litellm.responses.streaming_iterator import (
    BaseResponsesAPIStreamingIterator,
    MockResponsesAPIStreamingIterator,
    ResponsesAPIStreamingIterator,
    SyncResponsesAPIStreamingIterator,
)
from hypha.litellm.types.llms.anthropic_messages.anthropic_response import (
...
from hypha.litellm.types.rerank import OptionalRerankParams, RerankResponse
from hypha.litellm.types.responses.main import DeleteResponseResult
from hypha.litellm.types.router import GenericLiteLLMParams
...
from hypha.litellm.types.vector_stores import (
...
if TYPE_CHECKING:
    from hypha.litellm.litellm_core_utils.litellm_logging import Logging as _LiteLLMLoggingObj
...
class BaseLLMHTTPHandler:
    ...
    async def async_anthropic_messages_handler(
        ...
        from hypha.litellm.litellm_core_utils.get_provider_specific_headers import (
    ...
    def _handle_error(
        ...
        if provider_config is None:
            from hypha.litellm.llms.base_llm.chat.transformation import BaseLLMException
    ...
    def generate_content_handler(
        ...
        When _is_async=True, returns a coroutine instead of making the call directly.
        """
        from hypha.litellm.google_genai.streaming_iterator import (
