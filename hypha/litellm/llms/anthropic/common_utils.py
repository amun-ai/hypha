...
from hypha.litellm.types.llms.anthropic import AllAnthropicToolsValues, AnthropicMcpServerTool
...
class AnthropicTokenCounter(BaseTokenCounter):
    ...
    async def count_tokens(
        ...
        from hypha.litellm.proxy.utils import count_tokens_with_anthropic_api
