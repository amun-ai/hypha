...
from hypha.litellm.types.utils import Choices, ModelResponse, Usage

from .streaming_iterator import AnthropicStreamWrapper

if TYPE_CHECKING:
    from hypha.litellm.types.llms.anthropic import ContentBlockContentBlockDict
...
class LiteLLMAnthropicMessagesAdapter:
    ...
    def _translate_streaming_openai_chunk_to_anthropic_content_block(
        ...
        from hypha.litellm.types.llms.anthropic import TextBlock, ToolUseBlock
