...
from hypha.litellm.types.llms.vertex_ai import VertexPartnerProvider
from hypha.litellm.utils import ModelResponse
...
class VertexAIPartnerModels(VertexBase):
    ...
    def completion(
        ...
        try:
            ...
            from hypha.litellm.llms.anthropic.chat import AnthropicChatCompletion
            from hypha.litellm.llms.codestral.completion.handler import (
                CodestralTextCompletion,
            )
            from hypha.litellm.llms.openai_like.chat.handler import OpenAILikeChatHandler
