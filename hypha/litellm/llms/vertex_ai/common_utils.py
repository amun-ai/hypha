...
from hypha.litellm import supports_response_schema, supports_system_messages, verbose_logger
from hypha.litellm.constants import DEFAULT_MAX_RECURSE_DEPTH
from hypha.litellm.litellm_core_utils.prompt_templates.common_utils import unpack_defs
from hypha.litellm.llms.base_llm.base_utils import BaseLLMModelInfo, BaseTokenCounter
...
from hypha.litellm.types.llms.vertex_ai import PartType, Schema
from hypha.litellm.types.utils import TokenCountResponse
...
def is_global_only_vertex_model(model: str) -> bool:
    ...
    """
    from hypha.litellm.utils import get_supported_regions
...
class VertexAITokenCounter(BaseTokenCounter):
    ...
    async def count_tokens(
        ...
        from hypha.litellm.llms.vertex_ai.count_tokens.handler import VertexAITokenCounter
