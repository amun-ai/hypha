...
from hypha.litellm.llms.base_llm.chat.transformation import BaseConfig, BaseLLMException
...
from hypha.litellm.types.llms.anthropic import AnthropicThinkingParam
from hypha.litellm.types.llms.gemini import BidiGenerateContentServerMessage
...
from hypha.litellm.types.llms.vertex_ai import (
...
if TYPE_CHECKING:
    ...
    from hypha.litellm.types.utils import ModelResponseStream, StreamingChoices
...
class VertexGeminiConfig(VertexAIBaseConfig, BaseConfig):
    ...
    def _create_streaming_choice(
        ...
        """
        from hypha.litellm.types.utils import Delta, StreamingChoices
    ...
    def _process_candidates(
        ...
        from hypha.litellm.types.utils import ModelResponseStream
