...
from hypha.litellm.llms.openai.chat.gpt_transformation import OpenAIGPTConfig
from hypha.litellm.secret_managers.main import get_secret_str
from hypha.litellm.types.llms.mistral import MistralThinkingBlock, MistralToolCallMessage
...
class MistralConfig(OpenAIGPTConfig):
    ...
    def _clean_tool_schema_for_mistral(cls, tools: list) -> list:
        ...
        from hypha.litellm.utils import _remove_json_schema_refs
    ...
    def _is_empty_assistant_message(cls, message: AllMessageValues) -> bool:
        ...
        """
        from hypha.litellm.types.llms.openai import ChatCompletionAssistantMessage
