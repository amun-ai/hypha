...
from hypha.litellm.types.llms.azure_ai import ImageEmbeddingInput, ImageEmbeddingRequest
from hypha.litellm.types.llms.openai import EmbeddingCreateParams
