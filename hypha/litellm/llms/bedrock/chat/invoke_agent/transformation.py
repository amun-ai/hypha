...
from hypha.litellm.types.llms.bedrock_invoke_agents import (
...
from hypha.litellm.types.utils import Choices, Message, ModelResponse
...
class AmazonInvokeAgentConfig(BaseConfig, BaseAWSLLM):
    ...
    def _get_response_stream_shape(self):
        ...
        try:
            ...
            from hypha.litellm.llms.bedrock.chat.invoke_handler import (
    ...
    def _build_model_response(
        ...
        if usage_info:
            from hypha.litellm.types.utils import Usage
