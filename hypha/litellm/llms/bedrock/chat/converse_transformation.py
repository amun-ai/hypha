...
from hypha.litellm.constants import RESPONSE_FORMAT_TOOL_NAME
...
from hypha.litellm.llms.anthropic.chat.transformation import AnthropicConfig
...
from hypha.litellm.utils import add_dummy_tool, has_tool_call_blocks, supports_reasoning
...
class AmazonConverseConfig(BaseConfig):
    ...
    def get_supported_openai_params(self, model: str) -> List[str]:
        from hypha.litellm.utils import supports_function_calling
    ...
    def update_optional_params_with_thinking_tokens(
        ...
        """
        from hypha.litellm.constants import DEFAULT_MAX_TOKENS
