...
from hypha.litellm.llms.anthropic.experimental_pass_through.messages.transformation import (
    AnthropicMessagesConfig,
)
from hypha.litellm.llms.base_llm.anthropic_messages.transformation import (
    BaseAnthropicMessagesConfig,
)
from hypha.litellm.llms.bedrock.chat.invoke_handler import AWSEventStreamDecoder
from hypha.litellm.llms.bedrock.chat.invoke_transformations.base_invoke_transformation import (
    AmazonInvokeConfig,
)
from hypha.litellm.llms.bedrock.common_utils import get_anthropic_beta_from_headers
from hypha.litellm.types.router import GenericLiteLLMParams
from hypha.litellm.types.utils import GenericStreamingChunk
...
class AmazonAnthropicClaudeMessagesConfig(
    ...
    async def bedrock_sse_wrapper(
        ...
        """
        from hypha.litellm.llms.anthropic.experimental_pass_through.messages.streaming_iterator import (
