...
from hypha.litellm import LlmProviders
from hypha.litellm._logging import verbose_logger
from hypha.litellm.constants import DEFAULT_MAX_RETRIES
...
from hypha.litellm.llms.bedrock.chat.invoke_handler import MockResponseIterator
...
class OpenAIAssistantsAPI(BaseLLM):
    ...
    def create_thread(
        ...
        Here's an example:
        ```
        from hypha.litellm.llms.openai.openai import OpenAIAssistantsAPI, MessageData
