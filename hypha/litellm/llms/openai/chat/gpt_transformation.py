...
from hypha.litellm.litellm_core_utils.prompt_templates.common_utils import get_tool_call_names
from hypha.litellm.litellm_core_utils.prompt_templates.image_handling import (
    async_convert_url_to_base64,
    convert_url_to_base64,
)
from hypha.litellm.llms.base_llm.base_model_iterator import BaseModelResponseIterator
from hypha.litellm.llms.base_llm.base_utils import BaseLLMModelInfo
...
from hypha.litellm.utils import convert_to_model_response_object

from ..common_utils import OpenAIError

if TYPE_CHECKING:
    from hypha.litellm.litellm_core_utils.litellm_logging import Logging as _LiteLLMLoggingObj
    from hypha.litellm.types.llms.openai import ChatCompletionToolParam
