...
from hypha.litellm.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini import VertexLLM
...
class GoogleGenAIConfig(BaseGoogleGenAIGenerateContentConfig, VertexLLM):
    ...
    def map_generate_content_optional_params(
        ...
        """
        from hypha.litellm.types.google_genai.main import GenerateContentConfigDict
    ...
    def transform_generate_content_response(
        ...
        """
        from hypha.litellm.types.google_genai.main import GenerateContentResponse
        try:
