...
if TYPE_CHECKING:
    from hypha.litellm.types.google_genai.main import GenerateContentContentListUnionDict
else:
...
class GoogleAIStudioTokenCounter:
    ...
    async def validate_environment(
        ...
        """
        from hypha.litellm.llms.gemini.google_genai.transformation import GoogleGenAIConfig
