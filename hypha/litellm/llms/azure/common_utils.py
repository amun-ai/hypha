...
from hypha.litellm.llms.openai.common_utils import BaseOpenAILLM
from hypha.litellm.secret_managers.get_azure_ad_token_provider import (
...
from hypha.litellm.utils import _add_path_to_api_base
...
class BaseAzureLLM(BaseOpenAILLM):
    ...
    def _try_get_default_azure_credential_provider(
        ...
        """
        from hypha.litellm.types.secret_managers.get_azure_ad_token_provider import (
            AzureCredentialType,
        )
