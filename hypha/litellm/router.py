...
import hypha.litellm.litellm_core_utils.exception_mapping_utils
from hypha.litellm import get_secret_str
from hypha.litellm._logging import verbose_router_logger
from hypha.litellm.caching.caching import (
    DualCache,
    InMemoryCache,
    RedisCache,
    RedisClusterCache,
)
from hypha.litellm.constants import DEFAULT_MAX_LRU_CACHE_SIZE
from hypha.litellm.integrations.custom_logger import CustomLogger
from hypha.litellm.litellm_core_utils.asyncify import run_async_function
from hypha.litellm.litellm_core_utils.core_helpers import _get_parent_otel_span_from_kwargs
from hypha.litellm.litellm_core_utils.credential_accessor import CredentialAccessor
from hypha.litellm.litellm_core_utils.dd_tracing import tracer
from hypha.litellm.litellm_core_utils.litellm_logging import Logging as LiteLLMLogging
from hypha.litellm.router_strategy.budget_limiter import RouterBudgetLimiting
from hypha.litellm.router_strategy.least_busy import LeastBusyLoggingHandler
from hypha.litellm.router_strategy.lowest_cost import LowestCostLoggingHandler
from hypha.litellm.router_strategy.lowest_latency import LowestLatencyLoggingHandler
from hypha.litellm.router_strategy.lowest_tpm_rpm import LowestTPMLoggingHandler
from hypha.litellm.router_strategy.lowest_tpm_rpm_v2 import LowestTPMLoggingHandler_v2
from hypha.litellm.router_strategy.simple_shuffle import simple_shuffle
from hypha.litellm.router_strategy.tag_based_routing import get_deployments_for_tag
from hypha.litellm.router_utils.add_retry_fallback_headers import (
    add_fallback_headers_to_response,
    add_retry_headers_to_response,
)
from hypha.litellm.router_utils.batch_utils import (
    _get_router_metadata_variable_name,
    replace_model_in_jsonl,
    should_replace_model_in_jsonl,
)
from hypha.litellm.router_utils.client_initalization_utils import InitalizeCachedClient
from hypha.litellm.router_utils.clientside_credential_handler import (
    get_dynamic_litellm_params,
    is_clientside_credential,
)
from hypha.litellm.router_utils.cooldown_cache import CooldownCache
from hypha.litellm.router_utils.cooldown_handlers import (
...
from hypha.litellm.router_utils.fallback_event_handlers import (
...
from hypha.litellm.router_utils.handle_error import (
    async_raise_no_deployment_exception,
    send_llm_exception_alert,
)
from hypha.litellm.router_utils.pre_call_checks.prompt_caching_deployment_check import (
    PromptCachingDeploymentCheck,
)
from hypha.litellm.router_utils.pre_call_checks.responses_api_deployment_check import (
    ResponsesApiDeploymentCheck,
)
from hypha.litellm.router_utils.router_callbacks.track_deployment_metrics import (
...
from hypha.litellm.types.router import (
...
from hypha.litellm.types.services import ServiceTypes
from hypha.litellm.types.utils import GenericBudgetConfigType, LiteLLMBatch
from hypha.litellm.types.utils import ModelInfo
from hypha.litellm.types.utils import ModelInfo as ModelMapInfo
from hypha.litellm.types.utils import ModelResponseStream, StandardLoggingPayload, Usage
from hypha.litellm.utils import (
    CustomStreamWrapper,
    EmbeddingResponse,
    ModelResponse,
    Rules,
...
if TYPE_CHECKING:
    ...
    from hypha.litellm.router_strategy.auto_router.auto_router import (
        AutoRouter,
...
class Router:
    ...
    def __init__(  # noqa: PLR0915
        ...
        from hypha.litellm._service_logger import ServiceLogging
    ...
    def initialize_router_endpoints(self):
        ...
        # Vector Store routes
        #########################################################
        from hypha.litellm.vector_stores.main import acreate, asearch, create, search
        ...
        #########################################################
        from hypha.litellm.google_genai import (
            agenerate_content,
    ...
    async def _acompletion_streaming_iterator(
        ...
        """
        from hypha.litellm.exceptions import MidStreamFallbackError
        ...
        async def stream_with_fallbacks():
            try:
                ...
                from hypha.litellm.main import stream_chunk_builder
                    ...
                    if hasattr(fallback_response, "__aiter__"):
                        async for fallback_item in fallback_response:  # type: ignore
                            if (
                                ...
                                from hypha.litellm.cost_calculator import (
    ...
    async def _acreate_file(
        ...
        **kwargs,
        ...
        try:
            from hypha.litellm.router_utils.common_utils import add_model_file_id_mappings
    ...
    async def _init_responses_api_endpoints(
        ...
        **kwargs,
        ...
        """
        from hypha.litellm.responses.utils import ResponsesAPIRequestUtils
    ...
    async def deployment_callback_on_success(
        ...
        """
        from hypha.litellm.types.caching import RedisPipelineIncrementOperation
    ...
    def init_auto_router_deployment(self, deployment: Deployment):
        ...
        """
        from hypha.litellm.router_strategy.auto_router.auto_router import AutoRouter
    ...
    async def async_get_healthy_deployments(
        ...
        *OR*
        - Dict, if specific model chosen
        """
        from hypha.litellm.router_utils.common_utils import filter_team_based_models
