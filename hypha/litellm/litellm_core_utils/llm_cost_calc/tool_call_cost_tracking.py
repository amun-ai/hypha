...
from hypha.litellm.constants import OPENAI_FILE_SEARCH_COST_PER_1K_CALLS
...
class StandardBuiltInToolCostTracking:
    ...
    def _handle_web_search_cost(
        ...
        from hypha.litellm.llms import get_cost_for_web_search_request
    ...
    def response_object_includes_web_search_call(
        ...
        """
        from hypha.litellm.types.utils import PromptTokensDetailsWrapper
    ...
    def get_cost_for_file_search(
        ...
        if provider == "azure":
            from hypha.litellm.constants import AZURE_FILE_SEARCH_COST_PER_GB_PER_DAY
            if storage_gb and days:
    ...
    def get_cost_for_vector_store(
        ...
        if provider == "azure":
            from hypha.litellm.constants import AZURE_VECTOR_STORE_COST_PER_GB_PER_DAY
    ...
    def get_cost_for_code_interpreter(
        ...
        if provider == "azure":
            from hypha.litellm.constants import AZURE_CODE_INTERPRETER_COST_PER_SESSION
