...
from hypha.litellm.utils import get_model_info
...
class CostCalculatorUtils:
    ...
    def route_image_generation_cost_calculator(
        ...
        from hypha.litellm.llms.azure_ai.image_generation.cost_calculator import (
            cost_calculator as azure_ai_image_cost_calculator,
        )
        from hypha.litellm.llms.bedrock.image.cost_calculator import (
            cost_calculator as bedrock_image_cost_calculator,
        )
        from hypha.litellm.llms.gemini.image_generation.cost_calculator import (
            cost_calculator as gemini_image_cost_calculator,
        )
        from hypha.litellm.llms.recraft.cost_calculator import (
            cost_calculator as recraft_image_cost_calculator,
        )
        from hypha.litellm.llms.vertex_ai.image_generation.cost_calculator import (
        ...
        if custom_llm_provider == litellm.LlmProviders.VERTEX_AI.value:
            ...
            from hypha.litellm.llms.aiml.image_generation.cost_calculator import (
