...
from hypha.litellm.litellm_core_utils.json_validation_rule import normalize_tool_schema
...
class GoogleGenAIAdapter:
    """Adapter for transforming Google GenAI generate_content requests to/from hypha.litellm.completion format"""
    ...
    def translate_completion_to_generate_content(
        ...
        Args:
            response: ModelResponse from hypha.litellm.completion
    ...
    def translate_streaming_completion_to_generate_content(
        ...
        Args:
            response: Streaming ModelResponse chunk from hypha.litellm.completion
