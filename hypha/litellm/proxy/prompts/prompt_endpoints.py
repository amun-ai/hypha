...
from hypha.litellm.proxy._types import CommonProxyErrors, LitellmUserRoles, UserAPIKeyAuth
from hypha.litellm.proxy.auth.user_api_key_auth import user_api_key_auth
from hypha.litellm.types.prompts.init_prompts import (
    ListPromptsResponse,
    PromptInfo,
    PromptInfoResponse,
    PromptLiteLLMParams,
...
async def list_prompts(
    ...
    ```
    """
    from hypha.litellm.proxy._types import LitellmUserRoles
    ...
    try:
        ...
        if prompt_callback is not None:
            ...
            if integration_name == "dotprompt":
                ...
                from hypha.litellm.integrations.dotprompt.dotprompt_manager import (
                    DotpromptManager,
                )
...
async def convert_prompt_file_to_json(
    ...
    from hypha.litellm.integrations.dotprompt.prompt_manager import PromptManager
