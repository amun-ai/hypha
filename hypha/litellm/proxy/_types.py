...
from hypha.litellm.types.integrations.slack_alerting import AlertType
from hypha.litellm.types.llms.openai import AllMessageValues, OpenAIFileObject
...
from hypha.litellm.types.mcp_server.mcp_server_manager import MCPInfo
from hypha.litellm.types.router import RouterErrors, UpdateRouterConfig
from hypha.litellm.types.secret_managers.main import KeyManagementSystem
...
class UserAPIKeyAuth(
    ...
    def get_litellm_internal_health_check_user_api_key_auth(cls) -> "UserAPIKeyAuth":
        ...
        """
        from hypha.litellm.constants import LITTELM_INTERNAL_HEALTH_SERVICE_ACCOUNT_NAME
