...
from hypha.litellm.types.llms.anthropic import ANTHROPIC_API_HEADERS
...
class LiteLLMProxyRequestSetup:
    ...
    def add_litellm_metadata_from_request_headers(
        ...
        """
        from hypha.litellm.proxy._types import LitellmMetadataFromRequestHeaders
...
async def add_litellm_data_to_request(  # noqa: PLR0915
    ...
    from hypha.litellm.proxy.proxy_server import llm_router, premium_user
    from hypha.litellm.types.proxy.litellm_pre_call_utils import SecretFields
...
def _add_otel_traceparent_to_data(data: dict, request: Request):
    from hypha.litellm.proxy.proxy_server import open_telemetry_logger
