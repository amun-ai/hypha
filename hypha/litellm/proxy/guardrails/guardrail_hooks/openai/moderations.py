...
from hypha.litellm.integrations.custom_guardrail import (
    CustomGuardrail,
...
if TYPE_CHECKING:
    ...
    from hypha.litellm.types.llms.openai import AllMessageValues, OpenAIModerationResponse
    from hypha.litellm.types.proxy.guardrails.guardrail_hooks.base import GuardrailConfigModel
...
class OpenAIModerationGuardrail(OpenAIGuardrailBase, CustomGuardrail):
    ...
    async def async_make_request(
        ...
        from hypha.litellm.types.llms.openai import OpenAIModerationResponse
    ...
    async def async_post_call_streaming_iterator_hook(
        ...
        from hypha.litellm.types.utils import TextCompletionResponse
    ...
    def get_config_model() -> Optional[Type["GuardrailConfigModel"]]:
        ...
        """
        from hypha.litellm.types.proxy.guardrails.guardrail_hooks.openai.openai_moderation import (
