...
if TYPE_CHECKING:
    ...
    from hypha.litellm.types.proxy.guardrails.guardrail_hooks.azure.azure_text_moderation import (
    ...
    from hypha.litellm.types.utils import EmbeddingResponse, ImageResponse, ModelResponse
...
class AzureContentSafetyTextModerationGuardrail(AzureGuardrailBase, CustomGuardrail):
    ...
    async def async_post_call_success_hook(
        ...
        from hypha.litellm.types.utils import Choices, ModelResponse
