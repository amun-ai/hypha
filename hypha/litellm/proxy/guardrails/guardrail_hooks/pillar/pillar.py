...
# LiteLLM imports
from hypha.litellm import DualCache
...
from hypha.litellm.types.utils import LLMResponseTypes
from hypha.litellm._version import version as litellm_version
...
class PillarGuardrail(CustomGuardrail):
    ...
    def get_config_model() -> Optional[Type["GuardrailConfigModel"]]:
        ...
        """
        from hypha.litellm.types.proxy.guardrails.guardrail_hooks.pillar import (
