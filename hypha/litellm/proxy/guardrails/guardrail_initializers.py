...
def initialize_bedrock(litellm_params: LitellmParams, guardrail: Guardrail):
    from hypha.litellm.proxy.guardrails.guardrail_hooks.bedrock_guardrails import (
        BedrockGuardrail,
    )
...
def initialize_lakera(litellm_params: LitellmParams, guardrail: Guardrail):
    from hypha.litellm.proxy.guardrails.guardrail_hooks.lakera_ai import lakeraAI_Moderation
...
def initialize_lakera_v2(litellm_params: LitellmParams, guardrail: Guardrail):
    from hypha.litellm.proxy.guardrails.guardrail_hooks.lakera_ai_v2 import LakeraAIGuardrail
