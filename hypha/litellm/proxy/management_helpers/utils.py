...
from hypha.litellm.proxy._types import (  # key request types; user request types; team request types; customer request types
...
def _delete_user_id_from_cache(kwargs):
    from hypha.litellm.proxy.proxy_server import user_api_key_cache
