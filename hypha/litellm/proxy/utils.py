...
from hypha.litellm.constants import DEFAULT_MODEL_CREATED_AT_TIME, MAX_TEAM_LIST_LIMIT
...
from hypha.litellm.types.guardrails import GuardrailEventHooks
...
import hypha.litellm.litellm_core_utils.litellm_logging
from hypha.litellm import (
    EmbeddingResponse,
    ImageResponse,
    ModelResponse,
    ModelResponseStream,
...
from hypha.litellm._logging import verbose_proxy_logger
from hypha.litellm._service_logger import ServiceLogging, ServiceTypes
...
from hypha.litellm.integrations.SlackAlerting.utils import _add_langfuse_trace_id_to_alert
...
from hypha.litellm.litellm_core_utils.safe_json_loads import safe_json_loads
from hypha.litellm.llms.custom_httpx.httpx_handler import HTTPHandler
from hypha.litellm.proxy._types import (
    AlertType,
    CallInfo,
...
from hypha.litellm.proxy.auth.route_checks import RouteChecks
from hypha.litellm.proxy.db.create_views import (
    create_missing_views,
    should_create_missing_views,
)
from hypha.litellm.proxy.db.db_spend_update_writer import DBSpendUpdateWriter
from hypha.litellm.proxy.db.log_db_metrics import log_db_metrics
from hypha.litellm.proxy.db.prisma_client import PrismaWrapper
from hypha.litellm.proxy.hooks import PROXY_HOOKS, get_proxy_hook
from hypha.litellm.proxy.hooks.cache_control_check import _PROXY_CacheControlCheck
from hypha.litellm.proxy.hooks.max_budget_limiter import _PROXY_MaxBudgetLimiter
from hypha.litellm.proxy.hooks.parallel_request_limiter import (
    _PROXY_MaxParallelRequestsHandler,
)
from hypha.litellm.proxy.litellm_pre_call_utils import LiteLLMProxyRequestSetup
from hypha.litellm.secret_managers.main import str_to_bool
from hypha.litellm.types.integrations.slack_alerting import DEFAULT_ALERT_TYPES
from hypha.litellm.types.mcp import (
    MCPDuringCallResponseObject,
    MCPPreCallRequestObject,
    MCPPreCallResponseObject,
)
from hypha.litellm.types.utils import CallTypes, LLMResponseTypes, LoggedLiteLLMParams
...
class ProxyLogging:
    ...
    def _add_proxy_hooks(self, llm_router: Optional[Router] = None):
        ...
        """
        from hypha.litellm.proxy.proxy_server import prisma_client
    ...
    def _convert_mcp_to_llm_format(self, request_obj, kwargs: dict) -> dict:
        ...
        """
        from hypha.litellm.types.llms.openai import ChatCompletionUserMessage
    ...
    def _convert_llm_result_to_mcp_response(
        ...
        """
        from hypha.litellm.types.mcp import MCPPreCallResponseObject
    ...
    def _create_mcp_request_object_from_kwargs(
        ...
        """
        from hypha.litellm.types.llms.base import HiddenParams
        from hypha.litellm.types.mcp import MCPPreCallRequestObject
    ...
    async def pre_call_hook(
        ...
        3. /image/generation
        """
        from hypha.litellm.utils import get_non_default_completion_params
    ...
    async def async_post_call_streaming_hook(
        ...
        1. /chat/completions
        """
        from hypha.litellm.proxy.proxy_server import llm_router
...
class PrismaClient:
    ...
    async def _set_spend_logs_row_count_in_proxy_state(self) -> None:
        ...
        """
        from hypha.litellm.proxy.proxy_server import proxy_state
...
class ProxyUpdateSpend:
    ...
    def disable_spend_updates() -> bool:
        ...
        """
        from hypha.litellm.proxy.proxy_server import general_settings
...
def _premium_user_check():
    ...
    """
    from hypha.litellm.proxy.proxy_server import premium_user
...
async def get_available_models_for_user(
    ...
    """
    from hypha.litellm.proxy.auth.auth_checks import get_team_object
    from hypha.litellm.proxy.auth.model_checks import (
        get_complete_model_list,
        get_key_models,
        get_team_models,
    )
    from hypha.litellm.proxy.management_endpoints.team_endpoints import validate_membership
...
def create_model_info_response(
    ...
    """
    from hypha.litellm.proxy.auth.model_checks import get_all_fallbacks
