...
from hypha.litellm.proxy.hooks.user_management_event_hooks import UserManagementEventHooks
from hypha.litellm.proxy.management_endpoints.common_daily_activity import (
    get_daily_activity,
...
from hypha.litellm.proxy.utils import handle_exception_on_proxy
from hypha.litellm.types.proxy.management_endpoints.common_daily_activity import (
    SpendAnalyticsPaginatedResponse,
)
from hypha.litellm.types.proxy.management_endpoints.internal_user_endpoints import (
...
if TYPE_CHECKING:
    from hypha.litellm.proxy.proxy_server import PrismaClient
...
async def _add_user_to_team(
    ...
    from hypha.litellm.proxy.management_endpoints.team_endpoints import team_member_add
...
async def new_user(
    ...
    """
    try:
        from hypha.litellm.proxy.proxy_server import _license_check, prisma_client
...
async def user_info(
    ...
    try:
        ...
        team_list = []
        team_id_list = []
        from hypha.litellm.proxy.management_endpoints.team_endpoints import list_team
...
def _process_keys_for_user_info(
    ...
    from hypha.litellm.proxy.proxy_server import general_settings, litellm_master_key_hash
...
async def _update_single_user_helper(
    ...
    """
    from hypha.litellm.proxy.proxy_server import litellm_proxy_admin_name, prisma_client
...
async def get_user_key_counts(
    ...
    """
    from hypha.litellm.constants import UI_SESSION_TOKEN_TEAM_ID
