...
from hypha.litellm.proxy.management_helpers.utils import (
    add_new_member,
...
from hypha.litellm.types.proxy.management_endpoints.team_endpoints import (
...
class TeamMemberBudgetHandler:
    ...
    async def create_team_member_budget_table(
        ...
        from hypha.litellm.proxy._types import BudgetNewRequest
...
async def update_team(
    ...
    ```
    """
    from hypha.litellm.proxy.auth.auth_checks import _cache_team_object
    from hypha.litellm.proxy.proxy_server import (
        create_audit_log_for_update,
        litellm_proxy_admin_name,
        llm_router,
...
async def team_info(
    ...
    ```
    """
    from hypha.litellm.proxy._types import TeamInfoResponseObjectTeamTable
    from hypha.litellm.proxy.proxy_server import prisma_client
