...
from hypha.litellm.proxy._experimental.mcp_server.auth.user_api_key_auth_mcp import (
    MCPRequestHandler,
)
from hypha.litellm.proxy._experimental.mcp_server.utils import (
    LITELLM_MCP_SERVER_DESCRIPTION,
    LITELLM_MCP_SERVER_NAME,
    LITELLM_MCP_SERVER_VERSION,
)
from hypha.litellm.proxy._types import UserAPIKeyAuth
from hypha.litellm.types.mcp_server.mcp_server_manager import MCPInfo, MCPServer
from hypha.litellm.types.utils import StandardLoggingMCPToolCall
from hypha.litellm.utils import client
...
if MCP_AVAILABLE:
    ...
    from hypha.litellm.proxy._experimental.mcp_server.auth.litellm_auth_handler import (
        MCPAuthenticatedUser,
    )
    from hypha.litellm.proxy._experimental.mcp_server.mcp_server_manager import (
        global_mcp_server_manager,
    )
    from hypha.litellm.proxy._experimental.mcp_server.sse_transport import SseServerTransport
    ...
    async def mcp_server_tool_call(
        ...
        from hypha.litellm.exceptions import BlockedPiiEntityError, GuardrailRaisedException
    ...
    async def _list_mcp_tools(
        ...
        try:
            ...
            for tool in local_tools_raw:
                # Convert from hypha.litellm.types.mcp_server.tool_registry.MCPTool to mcp.types.Tool
