...
if MCP_AVAILABLE:
    from hypha.litellm.experimental_mcp_client.client import MCPTool
    from hypha.litellm.proxy._experimental.mcp_server.mcp_server_manager import (
        _convert_protocol_version_to_enum,
        global_mcp_server_manager,
    )
    from hypha.litellm.proxy._experimental.mcp_server.server import (
    ...
    async def call_tool_rest_api(
        ...
        from hypha.litellm.proxy.proxy_server import add_litellm_data_to_request, proxy_config
    ...
    ########################################################
    from hypha.litellm.proxy._experimental.mcp_server.server import MCPServer
