...
from hypha.litellm.constants import REDACTED_BY_LITELM_STRING, MAX_STRING_LENGTH_PROMPT_IN_DB
from hypha.litellm.litellm_core_utils.core_helpers import get_litellm_metadata_from_kwargs
from hypha.litellm.litellm_core_utils.safe_json_dumps import safe_dumps
from hypha.litellm.proxy._types import SpendLogsMetadata, SpendLogsPayload
from hypha.litellm.proxy.utils import PrismaClient, hash_token
...
def get_logging_payload(  # noqa: PLR0915
    ...
    from hypha.litellm.proxy.proxy_server import general_settings, master_key
...
def _sanitize_request_body_for_spend_logs_payload(
    ...
    """
    from hypha.litellm.constants import LITELLM_TRUNCATED_PAYLOAD_FIELD
