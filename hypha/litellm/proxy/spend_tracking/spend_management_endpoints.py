...
from hypha.litellm.proxy._types import ProviderBudgetResponse, ProviderBudgetResponseObject
from hypha.litellm.proxy.auth.user_api_key_auth import user_api_key_auth
from hypha.litellm.proxy.spend_tracking.spend_tracking_utils import (
...
async def get_global_spend_provider(
    ...
    from hypha.litellm.proxy.proxy_server import llm_router, prisma_client
...
async def calculate_spend(request: SpendCalculateRequest):
    ...
    """
    try:
        from hypha.litellm import completion_cost
        from hypha.litellm.cost_calculator import CostPerToken
...
async def global_spend_refresh():
    ...
    if view_exists:
        ...
        try:
            ...
            from hypha.litellm.proxy.utils import PrismaClient
