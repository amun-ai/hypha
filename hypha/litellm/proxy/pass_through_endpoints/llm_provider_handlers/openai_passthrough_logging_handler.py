...
from hypha.litellm.llms.openai.openai import OpenAIConfig
from hypha.litellm.llms.openai.openai import OpenAIConfig as OpenAIConfigType
from hypha.litellm.proxy._types import PassThroughEndpointLoggingTypedDict
from hypha.litellm.proxy.pass_through_endpoints.llm_provider_handlers.base_passthrough_logging_handler import (
    BasePassthroughLoggingHandler,
)
from hypha.litellm.proxy.pass_through_endpoints.success_handler import (
...
from hypha.litellm.types.utils import ImageResponse, LlmProviders, PassthroughCallTypes
from hypha.litellm.utils import ModelResponse, TextCompletionResponse
...
class OpenAIPassthroughLoggingHandler(BasePassthroughLoggingHandler):
    ...
    def _calculate_image_generation_cost(
        ...
        try:
            ...
            from hypha.litellm.cost_calculator import default_image_cost_calculator
    ...
    def _build_complete_streaming_response(
        ...
        try:
            ...
            from hypha.litellm.llms.openai.openai import OpenAIChatCompletionResponseIterator
            ...
            for chunk_str in all_chunks:
                try:
                    ...
                    from hypha.litellm.llms.base_llm.base_model_iterator import (
