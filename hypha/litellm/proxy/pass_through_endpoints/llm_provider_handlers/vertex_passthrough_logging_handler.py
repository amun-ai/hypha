...
from hypha.litellm.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini import (
...
class VertexPassthroughLoggingHandler:
    ...
    def vertex_passthrough_handler(
        ...
        **kwargs,
        ...
        if "generateContent" in url_route:
            ...
            from hypha.litellm.llms.vertex_ai.image_generation.image_generation_handler import (
                VertexImageGeneration,
            )
            from hypha.litellm.llms.vertex_ai.multimodal_embeddings.transformation import (
                VertexAIMultimodalEmbeddingConfig,
            )
            from hypha.litellm.types.utils import PassthroughCallTypes
            ...
            from hypha.litellm.llms.vertex_ai.vertex_ai_partner_models import (
    ...
    def _build_complete_streaming_response(
        ...
        if "generateContent" in url_route or "streamGenerateContent" in url_route:
            ...
            from hypha.litellm.llms.anthropic.chat.handler import ModelResponseIterator
