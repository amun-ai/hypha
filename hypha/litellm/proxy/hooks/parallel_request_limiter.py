...
from hypha.litellm import DualCache, ModelResponse
...
from hypha.litellm.proxy._types import CommonProxyErrors, CurrentItemRateLimit, UserAPIKeyAuth
...
class _PROXY_MaxParallelRequestsHandler(CustomLogger):
    ...
    async def get_internal_user_object(
        ...
        """
        from hypha.litellm._logging import verbose_proxy_logger
        from hypha.litellm.proxy.auth.auth_checks import get_user_object
