...
from hypha.litellm.litellm_core_utils.litellm_logging import StandardLoggingPayloadSetup
from hypha.litellm.proxy._types import UserAPIKeyAuth
from hypha.litellm.proxy.auth.auth_checks import log_db_metrics
from hypha.litellm.proxy.auth.route_checks import RouteChecks
from hypha.litellm.proxy.utils import ProxyUpdateSpend
...
class _ProxyDBLogger(CustomLogger):
    ...
    async def _PROXY_track_cost_callback(
        ...
        from hypha.litellm.proxy.proxy_server import proxy_logging_obj, update_cache
