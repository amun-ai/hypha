...
from hypha.litellm.litellm_core_utils.dot_notation_indexing import get_nested_value
...
from hypha.litellm.proxy.auth.auth_checks import can_team_access_model
...
class JWTAuthManager:
    ...
    async def sync_user_role_and_teams(
        ...
        if teams_to_add or teams_to_remove:
            from hypha.litellm.proxy.management_endpoints.scim.scim_v2 import (
