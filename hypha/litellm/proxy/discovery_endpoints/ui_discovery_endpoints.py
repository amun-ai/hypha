...
from hypha.litellm.types.proxy.discovery_endpoints.ui_discovery_endpoints import (
...
async def get_ui_config():
    from hypha.litellm.proxy.utils import get_proxy_base_url, get_server_root_path
