...
from hypha.litellm._logging import print_verbose, verbose_logger
from hypha.litellm.integrations.custom_logger import CustomLogger
from hypha.litellm.proxy._types import LiteLLM_TeamTable, UserAPIKeyAuth
from hypha.litellm.types.integrations.prometheus import *
from hypha.litellm.types.utils import StandardLoggingPayload
from hypha.litellm.utils import get_end_user_id_for_cost_tracking
...
class PrometheusLogger(CustomLogger):
    ...
    def _parse_prometheus_config(self) -> Dict[str, List[str]]:
        ...
        import litellm
        from hypha.litellm.types.integrations.prometheus import PrometheusMetricsConfig
    ...
    def _set_virtual_key_rate_limit_metrics(
        ...
        from hypha.litellm.proxy.common_utils.callback_utils import (
    ...
    async def initialize_remaining_budget_metrics(self):
        ...
        """
        from hypha.litellm.constants import PROMETHEUS_EMIT_BUDGET_METRICS_JOB_NAME
        from hypha.litellm.proxy.proxy_server import proxy_logging_obj
    ...
    async def _assemble_key_object(
        ...
        """
        from hypha.litellm.proxy.auth.auth_checks import get_key_object
        from hypha.litellm.proxy.proxy_server import prisma_client, user_api_key_cache
    ...
    def initialize_budget_metrics_cron_job(scheduler: AsyncIOScheduler):
        ...
        from hypha.litellm.constants import PROMETHEUS_BUDGET_METRICS_REFRESH_INTERVAL_MINUTES
        from hypha.litellm.integrations.custom_logger import CustomLogger
    ...
    def _mount_metrics_endpoint(premium_user: bool):
        ...
        from hypha.litellm.proxy._types import CommonProxyErrors
...
def _tag_matches_wildcard_configured_pattern(tags: List[str], configured_tag: str) -> bool:
    ...
    from hypha.litellm.router_utils.pattern_match_deployments import PatternMatchRouter
...
def get_custom_labels_from_tags(tags: List[str]) -> Dict[str, str]:
    ...
    from hypha.litellm.router_utils.pattern_match_deployments import PatternMatchRouter
    from hypha.litellm.types.integrations.prometheus import _sanitize_prometheus_label_name
